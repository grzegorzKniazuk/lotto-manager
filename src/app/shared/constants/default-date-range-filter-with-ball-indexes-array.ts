...
export const DEFAULT_DATE_RANGE_FILTER_AND_BALL_INDEXES_ARRAY = [ DateScoreFilter.SAME_MONTH_DAY_NUMBER, SCORE_NUMBERS_INDEXES_ARRAY ] as DateRangeFilterWithBallIndexesArray;
