...
import { selectNumbersScores } from 'src/app/modules/dashboard/store/selectors/score.selectors';
...
import { mapNumbersArrayToBallValuePercentage, mapScoresToNumbersArray } from 'src/app/shared/utils';

export const selectNumberOnIndexFrequency = createSelector(
    selectNumbersScores,
    (scores: Partial<Score[]>, props: { numberIndex: number, dateRange: DateScoreFilter }) => {
        let filteredNumbers;
