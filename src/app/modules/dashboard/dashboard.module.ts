...
import { AdviceParagraphComponent, GeneratorAdvicesComponent, LotteryNumbersSetGeneratorComponent, NumberDataChartComponent, ScoreListComponent } from 'src/app/modules/dashboard/components';
